...
def get_nonterms(grammar):
    #get all symbols that appear on the left hand side of a rule
    nonterms = []
    for rule in grammar:
...
def CKY(words, grammar, nonterms):
    ...
    #find probability of each word being generated by a symbol
    for index in range(num_words):
        ...
        added = True
        #find all unary rules leading down to word
        while added:
            added = False
                ...
                while added:
                    ...
                    for element in itertools.product(nonterms,nonterms):
                        ...
                        if prob > score[begin,end,A_index]:
                            score[begin,end,A_index] = prob
                            added = True
    #probability is value at "top" of the 'S' matrix
